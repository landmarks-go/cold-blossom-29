...
export BASE_MODEL='PeterJinGo/SearchR1-nq_hotpotqa_train-llama3.2-3b-em-ppo'
export EXPERIMENT_NAME='nq-search-r1-ppo-llama3.2-3b-em_nq_hotpotqa'
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.run_model \
    data.train_files=$DATA_DIR/train_forecast.parquet \
    data.val_files=$OUTPUT_DIR/questions.parquet \
